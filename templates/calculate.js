  ...
  //REPORTING
  REPORT.block.new("Development & Spl Basic Section Calculation", 2); // when creating a new block you can create an optional heading with a size (1-5 with 1 being the largest heading)
